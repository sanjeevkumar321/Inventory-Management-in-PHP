...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(pack == "") {
				$("#pack").after('<p class="text-danger">Pack field is required</p>');
				$('#pack').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#pack").find('.text-danger').remove();
				// success out for form 
				$("#pack").closest('.form-group').addClass('has-success');	  	
			}	// /else
			...
			if(mrp == "") {
				$("#mrp").after('<p class="text-danger">MRP field is required</p>');
				$('#mrp').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#mrp").find('.text-danger').remove();
				// success out for form 
				$("#mrp").closest('.form-group').addClass('has-success');	  	
			}	// /else
		...
		$.ajax({
			...
			// alert(response.product_image);
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(pack == "") {
						$("#editPack").after('<p class="text-danger">Pack field is required</p>');
						$('#editPack').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#editPack").find('.text-danger').remove();
						// success out for form 
						$("#editPack").closest('.form-group').addClass('has-success');	  	
					}	// /else
					...
					if(mrp == "") {
						$("#editMrp").after('<p class="text-danger">Mrp field is required</p>');
						$('#editMrp').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#editMrp").find('.text-danger').remove();
						// success out for form 
						$("#editMrp").closest('.form-group').addClass('has-success');	  	
					}	// /else

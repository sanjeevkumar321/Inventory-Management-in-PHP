	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" onchange="getCustomerdata()" placeholder="Contact Number" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->	
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:2%;">+Free</th>
			  			<th style="width:3%;">Pack</th>	
			  			<th style="width:5%;">Batch</th>
			  			<th style="width:5%;">Rate</th> 
			  			<th style="width:3%;">Exp</th> 
			  			<th style="width:4%;">MRP</th>
			  			<th style="width:2%;">SGST%<br>CGST%</th>	
			  			<th style="width:2%;">Dis%</th>		
			  		...
			  		for($x = 1; $x < 4; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:10px;">
			  					...
			  					<select class="form-control" name="productName[]" data-show-subtext="true" data-live-search="true" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  				...
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="number" name="free[]" id="free<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="0" value="0" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="text" name="pack[]" id="pack<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="text" name="batch[]" id="batch<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">			  					
			  				...
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="text" name="expDate[]" id="expDate<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="number" name="mrp[]" id="mrp<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="1"  />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="number" name="gstValue[]" id="gstValue<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="number" name="pdisValue[]" id="pdisValue<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">			  					
			  				...
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="text" name="netamount[]" id="netamount<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			orders.due, 
  			orders.payment_type,
  			orders.payment_status FROM orders 	
			  ...
			  <table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		order_item.rate, 
			  		order_item.total, 
			  		order_item.netamount FROM order_item WHERE order_item.order_id = {$orderId}";
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				...
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="number" name="free[]" id="free<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="0" value="<?php echo $orderItemData['free']; ?>" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="text" name="pack[]" id="pack<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="0" value="<?php echo $orderItemData['pack']; ?>"/>
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="text" name="batch[]" id="batch<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="0" value="<?php echo $orderItemData['batch']; ?>" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">			  					
			  				...
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="text" name="expDate[]" id="expDate<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" value="<?php echo $orderItemData['exp']; ?>" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="number" name="mrp[]" id="mrp<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="0" value="<?php echo $orderItemData['mrp']; ?>" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="number" name="gstValue[]" id="gstValue<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" value="<?php echo $orderItemData['gst']; ?>" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="number" name="pdisValue[]" id="pdisValue<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" value="<?php echo $orderItemData['dis']; ?>" />
			  					</div>
			  				</td>
			  				<td style="padding-left:10px;">			  					
			  				...
			  				<td style="padding-left:10px;">
			  					<div class="form-group">
			  					<input type="text" name="netamount[]" id="netamount<?php echo $x; ?>" onkeyup="" autocomplete="off" class="form-control" min="1" value="<?php echo $orderItemData['netamount']; ?>"  />
			  					</div>
			  				</td>
			  				<td>
...
<script src="custom/js/gst.js"></script>
